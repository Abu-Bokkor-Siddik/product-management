...
// all order
const allOrderToDB = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield order_model_1.orderModel.find();
    return result;
});
// find email order
const emailOrderToDB = (email) => __awaiter(void 0, void 0, void 0, function* () {
